...
class blueGhost
{
  ...
  blueGhost()
  {
    ...
    blue2 = color(33,91,165);
    mySkin = new skinGhosts();
    
    // check for problems!
    //println("LOAD ONCE: Blue ghost constructor");
  }
  ////////////////////////////////////////////////////////
  ...
  { 
    ...
    if(p_ghostX > ghostX)
    {
      pushMatrix();
        ...
        scale(-1, 1);
        mySkin.makeGhost(0,0,blue1,blue2);
      popMatrix();
    }
    // else turn ghost right
    else
    {
      mySkin.makeGhost(ghostX,ghostY,blue1,blue2);
    }
  }
  ////////////////////////////////////////////////////////
